...
The power and motor boards were received on the 23rd September 2019. As mentioned earlier, manufacture of the servo boards has not yet begun.

## Finishing electronic assembly of the boards

The boards are recieved from Beta Layout with all surface-mount and through-hole soldered components attached; however there are still a number of steps to be completed before the boards are ready for use.
...
Each board has a case made from laser-cut acrylic. Designs for these can be found in the respective hardware repositories. In the past we've been able to get time on ECS's laser cutting facilities to manufacture these.

Assembling the cases requires some screws and fixings etc. TODO: specifically what screws and fixings are needed?

## Adding the boards to the inventory

We should ensure the boards are in our asset tracker.
